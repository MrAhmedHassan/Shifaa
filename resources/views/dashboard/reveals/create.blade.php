...
<div class="container">
    ...
    <div class="alert alert-info alert-dismissable" style="font-family: 'Cairo', sans-serif">
        ...
        <strong>عزيزي المساعد</strong> .. لا تنس حذف الميعاد عند انتهاء اليوم ..
    </div>
    ...
    <div class="card mt-5">
        ...
        <div class="card-body px-lg-5 pt-0">
            ...
            <!-- Form -->
            <form class="text-right" method="post" action="/reveals/store" enctype="multipart/form-data">
                @csrf

                <!-- date -->
                <div class="md-form mt-3 mb-3" style="font-family: 'Cairo', sans-serif">
                    <label>التاريخ</label>
                    <input type="date" name="date" id="" class="form-control" value="" required>
                </div>
                <br>
                <!-- from -->
                <div class="form-group">
                    <label for="exampleFormControlInput2" class='font-weight-bold'> الكشف ابتداءا من</label>
                    <input type="time" name="start" class="form-control" id="" required>
                </div>

                <!-- to -->
                <div class="form-group">
                    <label for="exampleFormControlInput2" class='font-weight-bold'>نهاية الكشف</label>
                    <input type="time" name="end" class="form-control" id="" required>
                </div>
