...
<div class="container">
    ...
    <div class="card mt-5">
        ...
        <div class="card-body px-lg-5 pt-0">
            ...
            <!-- Form -->
            <form class="text-right" method="post" action="/articles/{{$article->id}}" enctype="multipart/form-data">
                {{method_field('PUT')}}
                @csrf
                <!-- title -->
                ...
                <div class="md-form mb-3">
                    ...
                    <textarea name="description" id="" class="form-control md-textarea" rows="7">{{$article->description}}</textarea>
                </div>
